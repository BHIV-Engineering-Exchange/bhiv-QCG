...
# -- Heartbeat & Lease -------------------------------------------------------
HEARTBEAT_TTL_SECONDS: int          = _int("QCG_HEARTBEAT_TTL_SECONDS", 30)
HEARTBEAT_CHECK_INTERVAL_SECONDS: int = _int("QCG_HEARTBEAT_CHECK_INTERVAL", 5)

# -- Service Certificates ----------------------------------------------------
CERTIFICATE_TTL_SECONDS: int        = _int("QCG_CERTIFICATE_TTL_SECONDS", 3600)
